...
/**
 * Source:
 * - https://github.com/researchstudio-sat/webofneeds/blob/bb732eb9080551838a1f72636e8042cc0bf67f55/webofneeds/won-matcher-solr/src/main/java/won/matcher/solr/utils/Kneedle.java
 *
 * Created by hfriedrich on 19.07.2016.
 *
 * Detect knee points in a curve using the "JKneedle" algorithm as described in the paper "Finding a" JKneedle" in a
...
public class JKneedle {
    ...
    public JKneedle(final double sensitivity) {
    ...
    /**
     * Detect all knee points in a curve according to "JKneedle" algorithm.
     ...
     */
    public int[] detectKneeOrElbowPoints(final double[] x, final double[] y, boolean detectElbows) {
